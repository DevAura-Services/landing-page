...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState([
        { text: "Hi there! 👋 How can I help you with your DevOps needs today?", sender: 'bot' }
    ]);
    ...
    const handleSend = (e) => {
        ...
        setTimeout(() => {
            setMessages(prev => [...prev, {
                text: "Thanks for reaching out! Our team will get back to you shortly. In the meantime, feel free to check out our services page.",
                sender: 'bot'
            }]);
        }, 1000);
            ...
            {isOpen && (
                <div className="fixed bottom-24 right-6 w-80 md:w-96 bg-[#1e293b] border border-white/10 rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden animate-in slide-in-from-bottom-10 fade-in duration-300">
                    ...
                    <div className="bg-blue-600 p-4 flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-white font-bold text-sm">Devaura Assistant</h3>

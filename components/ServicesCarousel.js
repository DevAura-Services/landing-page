    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center">
                ...
                <button
                    onClick={prev}
                    className="absolute left-0 z-20 p-2 bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-md transition-colors -ml-4 md:-ml-12 hidden md:block"
                    aria-label="Previous"
                >
                ...
                <button
                    onClick={next}
                    className="absolute right-0 z-20 p-2 bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-md transition-colors -mr-4 md:-mr-12 hidden md:block"
                    aria-label="Next"
                >
